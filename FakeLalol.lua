-- Fake Lalol Hub By Dr_Harkinian And Noobzz_4049
-- XD
-- Not a Require to lua
-- All from Official lalol hub
...
G2L["LocalScript_6"] = Instance.new("LocalScript", G2L["Execute_5"]);
...
G2L["11"]["Text"] = [[ pls put loadstring only! ]];
